...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
                    ...
                    @csrf
                        <div class="row">
                            <div class="col">
                                ...
                                {{-- <input name="nama_dokumen" type="text" class="form-control" placeholder="Nama Dokumen" value="{{isset($_GET['nama_dokumen']) ? $_GET['nama_dokumen'] : ''}}"> --}}
            ...
            <div class="ml-auto">
                {{-- <a href="{{ route('dokumen.index') }}" class="btn btn-primary"> <i class="fas fa-chevron-circle-left"></i> Index</a> --}}
                <a href="{{ route('dokumen.index') }}" class="btn btn-primary"> <i class="fas fa-broom"></i> Clear</a>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn btn-group">
                                <a href="{{ route('dokumen.show', [$dokuman]) }}" type="button" class="btn btn-secondary" title="Detail"> <i class="fas fa-eye"></i> </a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
